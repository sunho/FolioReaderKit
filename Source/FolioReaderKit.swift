...
extension FolioReader {
    ...
    open func presentReader(parentViewController: UIViewController, book: FRBook, config: FolioReaderConfig, animated:
        Bool = true) {
        let readerContainer = FolioReaderContainer(config: config, folioReader: self, book: book)
