...
open class FREpubParser: NSObject, SSZipArchiveDelegate {
    ...
    public func parseCoverImage(_ epubPath: String, unzipPath: String? = nil) throws -> UIImage {
    ...
    /// - Throws: `FolioReaderError`
    public func parseTitle(_ epubPath: String, unzipPath: String? = nil) throws -> String {
    ...
    /// - Throws: `FolioReaderError`
    public func parseAuthorName(_ epubPath: String, unzipPath: String? = nil) throws -> String {
    ...
    /// - Throws: `FolioReaderError`
    public func readEpub(epubPath withEpubPath: String, removeEpub: Bool = true, unzipPath: String? = nil) throws -> FRBook {
